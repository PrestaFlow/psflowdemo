...
└── tests/
    ├── flashlight-init/           Flashlight init-scripts: install the module, seed PSFLOWDEMO_TITLE
...
- A fresh Flashlight shop has no payment module configured, so the `Checkout` suite stops at the payment step there.
